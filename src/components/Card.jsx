...
function Card() {
  return (
    <div className='p-4 py-12 mx-auto grid md:grid-cols-3 gap-6'>
        <div data-aos="fade-up" data-aos-delay="0" className='relative rounded-xl border shadow-lg hover:scale-105 duration-300'>
        ...
        <div data-aos="fade-up" data-aos-delay="200" className='relative rounded-xl border shadow-lg hover:scale-105 duration-300'>
            <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
        ...
        </div><div data-aos="fade-up" data-aos-delay="400" className='relative rounded-xl border shadow-lg hover:scale-105 duration-300'>
            <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
